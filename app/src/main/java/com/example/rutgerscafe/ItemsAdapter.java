...
class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.ItemsHolder>{
    ...
    private ArrayList<DonutItem> items; //need the data binding to each row of RecyclerView

    public ItemsAdapter(Context context, ArrayList<DonutItem> items) {
                ...
                public void onClick(View view) {
                    ...
                    alert.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            String newPrice = tv_price.getText().toString().substring(1);
                            Double priceNum = Double.parseDouble(newPrice);
                            Donut currDonut = new Donut(tv_name.getText().toString(), priceNum, 1);
                            MainActivity.order.add(currDonut);
                        }
                        //handle the "NO" click
